...
Drinking, law strength, leisure seem to negatively associate with the firearm crude death rate. Self-rated health, smoking and unemployment rate positively associate with crude death rate. Note that the model generated from stepwise backward regression is the same as the "best subset" from criteria-based model search.
