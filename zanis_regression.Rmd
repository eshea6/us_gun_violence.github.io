...
```{r model_diagnostics}
# show boxcox, residuals diagnosis
par(mfrow = c(2,5))
...
Our four-predictor model seems to have a slightly lower root mean square error (RMSE) value than the six-predictor model. They are both better than the trivial model of y ~ 1. For parsimony, we would ultimately choose the four-predictor model.
